<script type="text/javascript">
    ...
    <form method="post" action="chargeCustomer" id="agent_company_reill">
        ...
        <div class="form-row">
            ...
            <div class="content">
                <input type="text" name="charge_amount"  class="required" />
            </div>
        </div>
        <div class="form-row">
            <div class="content">
                <input type="submit" name="Charge Customer" value="Charge Customer"  style='background: url("http://admin.zerocall.com/sf/sf_admin/images/b.png") repeat-x scroll left center transparent;
