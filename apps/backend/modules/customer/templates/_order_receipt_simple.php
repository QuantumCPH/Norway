...
<table class="receipt" cellspacing="0" width="520px">
  ...
  <tr> 
    ...
    <td style="padding-right:80; text-align:right"><?php echo format_number($subtotal = $transaction->getAmount()-$vat) //($order->getProduct()->getPrice() - $order->getProduct()->getPrice()*.2) * $order->getQuantity()) ?>&nbsp;Nkr</td>
  </tr>
  ...
  <tr class="footer"> 
    ...
    <td><?php //echo $order->getQuantity() ?></td>
    <td style="padding-right:80; text-align:right"><?php echo @$postalcharge ; ?>&nbsp;Nkr</td>
  </tr>
  <?php } ?>
  <tr class="footer">
    <td>&nbsp;</td>
    ...
    <td>&nbsp;</td>
    <td style="padding-right:80; text-align:right"><?php if($postalcharge && $order->getIsFirstOrder()){ echo format_number($transaction->getAmount()+$postalcharge); }else{ echo format_number($transaction->getAmount()); } ?>&nbsp;Nkr</td>
