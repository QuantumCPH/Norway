...
<tr  style="background-color:<?php echo $colorvalue;?>">
    ...
    <td align="right"><?php echo BaseUtil::format_number($transaction->getAmount()); $amount_total += $transaction->getAmount(); ?>&nbsp;<?php echo sfConfig::get('app_currency_code')?></td>
</tr>
<?php endforeach; ?>
...
<tr><td>&nbsp;</td>
    ...
    <td align="right"><?php echo BaseUtil::format_number($amount_total);  ?>&nbsp;<?php echo sfConfig::get('app_currency_code')?></td>
