...
<p style="align:justified;"><?php echo __('Tell your friends about Zapna and earn 10 Nkr as soon as your friends have made their first payment with Zapna! Spread the word about Zapna and let your friends know about Zapna services.') ?></p>
<br/>
...
<p style="align:justified;"><?php echo __("As soon as your friends have made their first payment with Zapna, you will automatically receive 10 Nkr in your Zapna balance - so if 10 of your friends register on Zapna, youll gain 100 Nkr in your account. Just share the news and enjoy this great new treat from Zapna.") ?> </p>
      ...
      <div class="fl col">
	    <form  id="form1" method="POST" action="<?php echo url_for('customer/tellAFriend', true) ?>">
                <table>
                    ...
                    <tr>
                        <td  colspan="2" align="center"><textarea name="message" ><?php echo __("Smartsim use to make extremely cheap international calls (save up to 90%) and to cut prices when you are abroad (you'll save 30-80%). Right now costing Smartsim 99 Nkr and you can call for the full amount. Smartsim has no monthly fee or hidden charges.") ?> </textarea></td>
