        ...
        <ul>
          ...
          <li>
            ...
            <?php } ?>
             ...
             <span><a href="http://zapna.no/wp-content/uploads/2012/12/termsandcondition.pdf" target="_blank" style="outline:none"><?php echo $form['terms_conditions']->renderHelp() ?></a></span>             
          </li>
          <li>
             <?php
