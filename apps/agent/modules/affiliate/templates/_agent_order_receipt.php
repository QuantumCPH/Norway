...
<tr bgcolor="#CCCCCC" class="receipt_header"> 
  ...
  <tr> 
   ...
   <?php echo __('Agent Refill');?>
    ...
    <td>1</td>
    <td style="padding-right:80px; text-align:right"><?php echo format_number($subtotal=$transaction) //($order->getProduct()->getPrice() - $order->getProduct()->getPrice()*.2) * $order->getQuantity()) ?>&nbsp;Nkr</td>
  </tr>
  <tr>
